  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <Link
            className="navbar-brand long_text"
            to="/"
            style={{ color: "white", fontWeight: 500, fontSize: 24 }}
          >
            <img src={logo} width="60" height="60" alt="IFKF-SL logo" />{" "}
            International Fumonkai Karate-do Federation - Sri Lanka
          </Link>
          {/* <Link
            className="navbar-brand short_text"
            to="/"
            style={{ color: "white", fontWeight: 500, fontSize: 24 }}
          >
            <img src={logo} width="60" height="60" alt="IFKF-SL logo" /> IFKF -
            Sri Lanka
          </Link> */}
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ml-auto">
              ...
              <Link className="nav-link" to="getintouch">
                <FontAwesomeIcon icon={faHandshake} /> Get in touch
              </Link>
              {loggedAsOperator && (
                <NavDropdown
                ...
                >
                  ...
                  <Link className="dropdown-item" to="sessions">
                    <FontAwesomeIcon icon={faCalendarAlt} /> Sessions
                  </Link>
                  ...
                  <Link className="dropdown-item" to="/equipment">
                    <FontAwesomeIcon icon={faPencilRuler} /> Equipments
                  </Link>
                  ...
                  <Link className="dropdown-item" to="update">
                    <FontAwesomeIcon icon={faUserCircle} /> Update
                  </Link>
                </NavDropdown>
              )}
