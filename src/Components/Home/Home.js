            ...
            <div >
                            <CardDeck className={"my-5"}>
                                ...
                                <Card style={{width: '18rem'}}>
                                    ...
                                    <ListGroup variant="flush">
                                        <Card.Body>
                                            <Card.Subtitle className="mb-2 text-muted" style={{color:" #000000"}}>Rank
                                                qualification</Card.Subtitle>
                                            <Card.Text style={{color:" #000000"}}><br/>
                                ...
                                <Card style={{width: '18rem'}}>
                                    ...
                                    <Card.Body>
                                        <Card.Title style={{color:" #000000"}}>Nimal Kalupahana</Card.Title>
                                        <Card.Subtitle className="mb-2 text-muted" style={{color:" #000000"}}>Text text text</Card.Subtitle>
                                ...
                                <Card style={{width: '18rem'}}>
                                    ...
                                    <Card.Body>
                                        <Card.Title style={{color:" #000000"}}>Honmen Yamato</Card.Title>
                                        <Card.Subtitle className="mb-2 text-muted">President of the International Karate
                                            Federation</Card.Subtitle>
