                ...
                <Carousel className={"img_overlay img-hover-zoom"}>
                    ...
                    <Carousel.Item interval={10}>
                        ...
                        <Carousel.Caption className="centered" style={{width:'80%'}}>
                            <h4>“The ultimate aim of Karate lies not in victory or defeat, but in the perfection of the character of its participants.”</h4>
                    ...
                    <Carousel.Item>
                        ...
                        />
                        <Carousel.Caption className="centered" style={{width:'80%'}}>
                            <h4>“Karate aims to build character, improve human behavior, and cultivate modesty; it does not, however, guarantee it.”</h4>
                            ...
                            <CardDeck className={"my-5"}>
                                ...
                                <Card style={{width: '18rem'}}>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Subtitle className="mb-2 text-muted">President of the International Karate Federation</Card.Subtitle>
                                    ...
                                    <ListGroup variant="flush">
                                        <Card.Body>
                                            <Card.Subtitle className="mb-2 text-muted">Rank qualification</Card.Subtitle>
                                            <Card.Text><br/>
